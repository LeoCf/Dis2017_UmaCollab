...
{
    public class StarBehaviorDesign : Behavior<View>
    {
        //two members: one the tap recognizer and the other a list of StarBehaviorDesign objects
        ...
        public static readonly BindableProperty RatingProperty =
            BindableProperty.Create("Rating",
                typeof(int),
                typeof(StarBehaviorDesign), default(int));
        ...
        {
            StarBehaviorDesign StarBehaviorDesign = (StarBehaviorDesign) bindable;

            if ((bool) newValue)
            {
                List<StarBehaviorDesign> behaviors = Behaviors;
                ...
                {
                    if (behavior != StarBehaviorDesign && !done)
                    {
                        behavior.IsStarred = true;
                    }
                    else if (behavior == StarBehaviorDesign)
                    {
                        done = true;
                        behavior.IsStarred = true;
                        position = counter;
                    }
                    else if (behavior != StarBehaviorDesign && done)
                    {
